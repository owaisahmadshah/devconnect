...
export const ContinueWithGoogle = () => {
  ...
  return (
    <Button
      ...
      className="border-border bg-background text-foreground hover:bg-accent hover:text-accent-foreground relative h-11 w-full items-center justify-center gap-3 font-semibold transition-all"
    >
